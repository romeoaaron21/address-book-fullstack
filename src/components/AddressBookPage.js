    ...
    <React.Fragment>
        ...
        <Grid item xs={12} md={9}>
          <Paper className={classes.root}>
            ...
            <Table className={classes.table}>
              ...
              <TableBody style={{ overflow: 'auto', border: '3px solid' }}>
                {rows.map(row => (
                  <TableRow key={row.name}>
                    <TableCell component="th" scope="row">
                      {row.first_name}
                    ...
                    <TableCell align="right">
                      <Fab size="small" style={{ backgroundColor: '#833ab4' }} className={classes.action}>
                        <EditIcon />
                      </Fab>
                      <Fab size="small" style={{ backgroundColor: '#fd1d1d',  margin: '0 10px' }} className={classes.action}>
                        <DeleteIcon />
                      </Fab>
                      <Fab size="small" style={{ backgroundColor: '#fcb045' }} className={classes.action}>
                        <GroupAddIcon />
                      </Fab>
                    </TableCell>
                  </TableRow>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title" maxWidth={'md'} fullWidth={true}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleClose} style={{ backgroundColor: '#fcb045', color: 'white', margin: '15px', padding: '10px 30px' }}>
            Add Contact
          </Button>
        </DialogActions>
      </Dialog>
